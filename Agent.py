...
class Agent:
    ...
    def __init__(self, actions, memory_size, input_size, min_blanks, target_update_period, batch_size, discount):
        ...
        self.environment = Environment(min_blanks, 3)  # instance of the environment class
